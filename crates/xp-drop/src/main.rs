...
fn main() {
        ...
        println!("------------------------");
        {
                ...
                tea::info!("v________________________v");
                let some_struct_with_const =
                        HasConstField { constantine: CONST_ZERO_WITH_DESTRUCTOR, field: 100001 };
                let some_struct_with_static =
                        HasConstField { constantine: STATIC_ZERO_WITH_DESTRUCTOR.clone(), field: 8118 };
