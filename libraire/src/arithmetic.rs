...
///
/// ```
/// use libraire::arithmetic::add_ample_room;
///
...
///
/// ```
/// use libraire::arithmetic::add_can_overflow;
///
...
///
/// ```
/// use libraire::arithmetic::add_can_err;
///
